 ...
 */
package crimesbymonthineachyear;
 ...
 * @author Sattya
 */
public class CrimesByMonthInEachYear extends Configured implements Tool{
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CrimesByMonthInEachYear(), args);
        System.exit(res);
    }
}
