 ...
 * @author Sattya
 */
public class CrimesByWeekDayYear extends Configured implements Tool{
        ...
        public void map(Text key, Text value, OutputCollector<Text, IntWritable> output, Reporter reporter) throws IOException {
        	...
        	String[] cols = line.split(",");
                try {
                    ...
                    String day[] = fdate.toString().split(" ");
                    word.set(day[0]+"_"+cols[17]);
    ...
    public int run(String[] args) throws Exception {
        ...
        JobConf job = new JobConf(conf, CrimesByWeekDayYear.class);
        ...
        job.setJobName("CrimesByWeekDayYear");
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CrimesByWeekDayYear(), args);
        System.exit(res);
    }
}
