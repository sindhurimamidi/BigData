 ...
 * @author Sattya
 */
public class CrimesProcessingTimes extends Configured implements Tool{
    ...
    public int run(String[] args) throws Exception {
        ...
        JobConf job = new JobConf(conf, CrimesProcessingTimes.class);
        ...
        job.setJobName("CrimesProcessingTimes");
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CrimesProcessingTimes(), args);
        System.exit(res);
    }
}
