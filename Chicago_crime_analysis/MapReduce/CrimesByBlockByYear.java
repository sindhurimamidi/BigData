 ...
 * @author Sattya
 */
public class CrimesByBlockByYear extends Configured implements Tool{
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CrimesByBlockByYear(), args);
        System.exit(res);
    }
}
