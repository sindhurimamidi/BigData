 ...
 * @author Sattya
 */
public class CrimesByWeekDay extends Configured implements Tool{
    ...
    public int run(String[] args) throws Exception {
        ...
        JobConf job = new JobConf(conf, CrimesByWeekDay.class);
        ...
        job.setJobName("CrimesByWeekDay");
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CrimesByWeekDay(), args);
        System.exit(res);
    }
}
